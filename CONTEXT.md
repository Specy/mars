...
This context defines the source-level concepts used to construct one assemblable MIPS program.

## Language

**Source Set**:
A collection of named MIPS source files available to one assembly. Merely belonging to the source set does not cause a file to be assembled.
