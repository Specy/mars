...
public final class JsPokeWrite {
    ...
    static JSObject register(String name, int oldValue, int newValue) {
        return createRegister(name, oldValue, newValue);
    }
    ...
    private static native JSObject createRegister(String name, int oldValue, int newValue);
