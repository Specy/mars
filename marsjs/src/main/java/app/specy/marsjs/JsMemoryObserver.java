...
import app.specy.mars.mips.hardware.AccessNotice;
import app.specy.mars.mips.hardware.MemoryAccessNotice;
...
/**
 * Bridges one MARS memory observation to plain JavaScript functions.
 *
